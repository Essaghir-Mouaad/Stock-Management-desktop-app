      ...
      steps: [
        {
          element: "#backup",
          intro:
            "هذا القسم مهم جدًا لإدارة النسخ الاحتياطي. في أي وقت ترغب بمراجعة مخزونك، كل ما عليك فعله هو الضغط على أحد الأزرار لإرسال البيانات إلى مفتاح USB الخاص بك وذلك للحماية وتعزيز أمان البيانات. للقيام بذلك، اختر القرص الخاص بك واضغط على زر اختبار القرص، ثم يمكنك الانتظار حتى نهاية اليوم ودفع البيانات إلى مفتاح USB، أو تفعيل النسخ التلقائي كل ساعة. لمزيد من المعلومات، يُرجى مراجعة النسخة PDF...",
        },
        {
          element: "#yearBtn",
          intro:
            "اختر السنة التي تريد عرض التحليلات الخاصة بها لمتابعة الأداء السنوي للمخزون.",
        },

        {
          element: "#monthBtn",
          intro:
            "اختر الشهر الذي تريد معرفة تحليلاته، لتتمكن من عرض بيانات المخزون الشهرية بدقة.",
        },
        {
          element: "#stockValueBtn",
          intro:
            "يمكنك عرض القيمة الإجمالية للمخزون في تقرير الطباعة سواء كان يوميًا أو شهريًا، لمتابعة الوضع المالي للمخزون.",
        },
        {
          element: "#dayBtn",
          intro:
            "اختر اليوم الذي تريد معرفة التحليلات اليومية الخاصة بالمخزون لكل منتج.",
        },
        {
          element: "#numberOfStudentBtn",
          intro:
            "هذا الزر مهم جدًا لحساب الاستهلاك لكل طالب عند طباعة التقرير السنوي، فهو يحدد الأساس الذي يُحسب عليه الاستهلاك.",
        },
        {
          element: "#printBtn",
          intro:
            "زر الطباعة سيكون معطلًا إذا كان عدد الطلاب يساوي صفر أو واحد لضمان صحة الحسابات في التقرير.",
        },
        {
          element: "#globalVue",
          intro:
            "يعرض هذا القسم رؤية شاملة لجميع المنتجات والفئات، لتقييم الأداء العام للمخزون.",
        },
        {
          element: "#dailyVue",
          intro:
            "يعرض هذا القسم الأداء اليومي للمنتجات والفئات لمتابعة حركة المخزون يوميًا.",
        },
        {
          element: "#monthlyVue",
          intro:
            "يعرض هذا القسم الأداء الشهري للمنتجات والفئات لمتابعة الاتجاهات على مدى الشهر.",
        },
        {
          element: "#categoryVue",
          intro:
            "يعرض هذا القسم الأداء حسب الفئات المختلفة، مما يتيح لك معرفة أكثر الفئات نشاطًا وربحية.",
        },
        {
          element: "#numberOfProducts",
          intro:
            "يعرض هذا القسم العدد الإجمالي للمنتجات الموجودة في المخزون بالكامل.",
        },
        {
          element: "#valueTotal",
          intro:
            "يعرض هذا القسم القيمة الإجمالية لمخزون المنتجات، ويتم تحديثه تلقائيًا بعد أي عملية إدخال أو إخراج.",
        },
        {
          element: "#underStock",
          intro:
            "يعرض هذا القسم عدد المنتجات التي وصل مخزونها إلى الحد الأدنى، لتنبيهك بإعادة التزويد سريعًا.",
        },
        {
          element: "#highStock",
          intro:
            "يعرض هذا القسم أفضل الفئات أداءً من حيث الحركة والبيع، لمساعدتك على اتخاذ القرارات المناسبة.",
        },
      ],
    });
